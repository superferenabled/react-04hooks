...
export const InstagromApp = () => {
    ...
    const [optimisticComments, addOptimisticComment] = useOptimistic(
        comments,
        (currentComments, newCommnent: string) => {
            lastId++;
            return [
                ...currentComments,
                {
    ...
    const handleAddComment = async (formData: FormData) => {
        ...
        startTransition(async () => {
            ...
            // code to revert the process
            setComments((prev) => prev);
            toast('Error adding your comment', {
        ...
        <div className="bg-slate-700 h-screen flex flex-col items-center justify-center">
            ...
            >
                ...
                <button
                    type="submit"
                    disabled={isPending}
                    className={`${isPending ? 'bg-gray-500' : 'bg-blue-500'} text-white p-2 rounded-md w-full`}
                >
                    Enviar
                </button>
            </form>
